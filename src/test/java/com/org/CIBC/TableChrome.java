...
import wrappers.Wrappersclass;

public class TableChrome {

	
	WebDriver driver;
	Wrappersclass wc=new Wrappersclass();
		 ...
		 @Test
		 public void Handle_Dynamic_Webtable() throws Exception {
		 
			 wc.getscreenshot(driver);
